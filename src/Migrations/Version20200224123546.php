 ...
 */
final class Version20200224123546 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE result (id INT AUTO_INCREMENT NOT NULL, candidate_id INT DEFAULT NULL, criteria_id INT DEFAULT NULL, oral INT DEFAULT NULL, test INT NOT NULL, coeforal DOUBLE PRECISION NOT NULL, coeftest DOUBLE PRECISION NOT NULL, average DOUBLE PRECISION DEFAULT NULL, acquis VARCHAR(255) DEFAULT NULL, INDEX IDX_136AC11391BD8781 (candidate_id), INDEX IDX_136AC113990BEA15 (criteria_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
